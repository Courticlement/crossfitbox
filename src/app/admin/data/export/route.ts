...
export async function GET(request: Request) {
  ...
  classesSheet.columns = [
    ...
    { header: "Athlète", key: "athlete", width: 18 },
    { header: "Abonné", key: "athleteIsMember", width: 10 },
  ...
  for (const inst of instances) {
    classesSheet.addRow({
      ...
      athlete: inst.athleteName ?? "",
      athleteIsMember: inst.athleteName ? (inst.athleteIsMember ? "Oui" : "Non") : "",
