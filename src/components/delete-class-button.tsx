  ...
  return (
    ...
    >
      ...
      <button
        ...
        className={`shrink-0 rounded-md p-1 text-base text-neutral-500 md:p-0 md:text-[10px] md:opacity-0 md:group-hover:opacity-100 ${light ? "hover:text-red-600" : "hover:text-red-300"}`}
      >
        ✕
      </button>
    </form>
